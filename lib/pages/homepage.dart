...
import 'package:expense/APage.dart';
import 'package:expense/BPage.dart';
import 'package:expense/CPage.dart';
import 'package:expense/DPage.dart';
      ...
      body: FutureBuilder<List<TransactionModel>>(
        ...
        if (snapshot.hasData){
          if(snapshot.data!.isEmpty)
            {
              return Center(child: Text("請新增記帳項目!!"),);
            }
               ...
               child: Row(
                 ...
                 children: [
                   Row(
                     children: <Widget>[
                       OutlinedButton(
                         child: const Icon(Icons.edit_calendar ,size:50),
                         onPressed: () {
                           Navigator.of(context).push(MaterialPageRoute(builder: (context) => DPage()
                             ));
                         },
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Column(children: [
                    Text("總收益", textAlign: TextAlign.center,style: TextStyle
                    ...
                    Text("$totalBalance 元", textAlign: TextAlign.center,style: TextStyle
      ...
      Padding(
        ...
        child: Text("${date.day} ${months[date.month -1]} ${date.year}",
          ...
          Column(
            ...
            children: [
              Text(" - $value 元",style: TextStyle(fontSize: 24.0,fontWeight: FontWeight.w700,
              ),
              ),
